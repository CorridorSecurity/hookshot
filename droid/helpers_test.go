...
// =============================================================================
// Stop / SubagentStop Helpers Tests
// =============================================================================
...
func TestAllowWithInput(t *testing.T) {
	...
	if output.HookSpecificOutput.PermissionDecisionReason != "Modified input" {
		t.Errorf("PermissionDecisionReason = %q, want %q", output.HookSpecificOutput.PermissionDecisionReason, "Modified input")
	}
...
func TestDenyPermissionAndStop(t *testing.T) {
	...
	if output.HookSpecificOutput.Decision.Message != "Critical error" {
		t.Errorf("Message = %q, want %q", output.HookSpecificOutput.Decision.Message, "Critical error")
	}
